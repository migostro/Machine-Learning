...
(function() {
  ...
  var data = {
    params: window.ftParams_4200532 || '',
    guid: window.ftGUID_4200532 || '',
    confID: window.ftConfID_4200532 || '0',
    ftReturn: window.ftReturn_4200532 || '',
    keyword: window.ftKeyword_4200532 || '',
    ftId: window.ftId_4200532 || '',
    ftImpId: window.ftImp4200532 && window.ftImp4200532.impID || '',
    gdpr: window.ftImp4200532 && window.ftImp4200532.gdpr || '',
    gdpr_consent: window.ftImp4200532 && window.ftImp4200532.gdpr_consent || '',
    gdpr_pd: window.ftImp4200532 && window.ftImp4200532.gdpr_pd || '',
    us_privacy: window.ftImp4200532 && window.ftImp4200532.us_privacy || '',
    campaignID: '115847',
    cID: '100965',
    pID: '4200532',
    creativeID: '2575464',
    ...
    extscript: [
      "https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=115847&sid=18330&plc=4200532&num=&adid=&advid=&adsrv=29&btreg=4200532&btadsrv=flashtalking&crt=2575464&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src&dvp_ftimpid=[FT_IMPRESSIONID]"
    ],
    clickTags: ['http://servedby.flashtalking.com/click/8/115847;4200532;2575464;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.adobe.com/br/creativecloud/photography.html?sdid=N3PCRX5W&mv=display'],
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?172128739-4200532;2575464;',
    centreAd: true,
    width: 728,
    height: 90,
    adType: 'altimage'.toLowerCase(),
    altimg: 'http://cdn.flashtalking.com/xre/420/4200532/2575464/image/2575464.gif',
    viewableImpressionURL: 'http://servedby.flashtalking.com/imp/8/115847;4200532;202;pixel;DV360;DV360FY20CCRTRDigitalImagingBRDSKBAN728x90/?',
    stump: 'http://servedby.flashtalking.com',
    altimghref: 'http://servedby.flashtalking.com/click/8/115847;4200532;2575464;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.adobe.com/br/creativecloud/photography.html?sdid=N3PCRX5W&mv=display',
    divID: 'ftdiv4200532',
    altimgID: 'ftalt4200532',
    alttext: 'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp4200532 && parseInt(window.ftImp4200532.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m4200532') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m4200532'),
    pageVisible: 'maybe',
...
(function(o) {
	if (o.width === 1 && o.height === 2){
		o.addEventListener("obaEnd", function(){
		    try {
		        document.getElementById("ftAdChoices_4200532").style.display = "none";

		    } catch(e){
		        window.parent.document.getElementById("ftAdChoices_4200532").style.display = "none";
		    }
		});
	}
}(ft4200532));
...
(function(o){
    ...
    var scriptToFire = "https://js.ad-score.com/score.min.js?pid=1000557&tt=g#tid=13539&l1=115847&l2=DV360&l3=4200532&l4=2575464&l5=&l6=&utid=[%FT_IMPRESSIONID%]&cb=[%random%]";
    var pixelToFire = "https://img-1000557.ad-score.com/img?pid=1000557&tid=13539&tt=g&l1=115847&l2=DV360&l3=4200532&l4=2575464&utid=[%FT_IMPRESSIONID%]&creative_type=display&cb=[%random%]";
